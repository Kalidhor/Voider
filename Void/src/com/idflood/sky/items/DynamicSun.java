...
public class DynamicSun extends Node {
    private static final Sphere sphereMesh = new Sphere(0x28, 0x28, 0x384, false, true);
    
    private ViewPort viewPort = null;
    private AssetManager assetManager = null;
    
    private SunSystem sunSystem = new SunSystem(new Date(), 0x00, 0x00, 0x00);
    ...
    public DynamicSun(AssetManager assetManager, ViewPort viewPort, Node rootNode, Float scaling) {
        ...
        mat.setTexture("ColorMap", assetManager.loadTexture("Textures/Sun/sun.png"));
    ...
    public void updateTime() {
        ...
        sunSystem.updateSunPosition(0x00, 0x00, 0x0A); // increment by 30 seconds
        updateLightPosition();
