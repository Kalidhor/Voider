...
public class DynamicStars extends Node{
    ...
    public DynamicStars(AssetManager assetManager, ViewPort viewPort, Float scaling){
        ...
        mat.setTexture("ColorMap", assetManager.loadTexture("Textures/Sun/star.png"));
        ...
        for(int i = 0; i < stars_count; i++){
            ...
            item.lookAt(getRandomVector().mult(0x0A), Vector3f.UNIT_Y);
