...
public class DynamicSkyBackground {
    ...
    protected Material getDynamicSkyMaterial(){
        ...
        skyMat.setTexture("glow_texture", assetManager.loadTexture("Textures/Sun/glow.png"));
        skyMat.setTexture("color_texture", assetManager.loadTexture("Textures/Sun/sky.png"));
